...
public class ApplicationGUI_Server extends javax.swing.JFrame {
    
    
    /**
     * Creates new form ApplicationGUI
     */
    public ApplicationGUI_Server() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnContrasena, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnInterrumpirConexion, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        try {
            ...
            if (f.exists()) {
                ...
                try {
                    ...
                    for (int i = 0; i < listPass.size() && encontrado == false; i = i + 2) {
                        if (contrasena.equals(listPass.get(i))) {
                            System.out.println("Error, la contraseña " + contrasena + " ya se encuentra en el rainbow table, intente con otra.");
                            s.close();
                            bandera = true;
                            encontrado = true;
                        }
                    ...
                    if (bandera == false) {
                        Writer output;
                        try {
                            output = new BufferedWriter(new FileWriter("passwords.txt", true));  //clears file every time

                            output.append(contrasena + "    " + sha256Hash + "\n");
                            output.close();
                            s.close();
                        } catch (IOException ex) {
                            System.out.println("Error abriendo y añadiendo texto al archivo: " + ex.getMessage());
                        }
                    }
                } catch (FileNotFoundException ex) {
                    System.out.println("Error leyendo y extrayendo la información: " + ex.getMessage());
                }
            } else {
                try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApplicationGUI_Server.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApplicationGUI_Server().setVisible(true);
            }
        });
    }
